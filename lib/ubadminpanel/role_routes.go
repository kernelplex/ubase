...
func RoleOverviewRoute(adapter ubdata.DataAdapter, mgmt ubmanage.ManagementService, permissions []string) ubwww.Route {
    ...
    return ubwww.Route{Path: "GET /admin/roles/{id}", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RoleUsersListRoute(adapter ubdata.DataAdapter) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        idStr := r.PathValue("id")
        id, err := strconv.ParseInt(idStr, 10, 64)
        if err != nil || id <= 0 {
    ...
    return ubwww.Route{Path: "GET /admin/roles/{id}/users", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RoleUsersAddRoute(adapter ubdata.DataAdapter, mgmt ubmanage.ManagementService) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        idStr := r.PathValue("id")
        id, err := strconv.ParseInt(idStr, 10, 64)
        if err != nil || id <= 0 {
    ...
    return ubwww.Route{Path: "POST /admin/roles/{id}/users/add", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RoleUsersRemoveRoute(adapter ubdata.DataAdapter, mgmt ubmanage.ManagementService) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        idStr := r.PathValue("id")
        id, err := strconv.ParseInt(idStr, 10, 64)
        if err != nil || id <= 0 {
    ...
    return ubwww.Route{Path: "POST /admin/roles/{id}/users/remove", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RolePermissionsListRoute(adapter ubdata.DataAdapter, permissions []string) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        idStr := r.PathValue("id")
        id, err := strconv.ParseInt(idStr, 10, 64)
        if err != nil || id <= 0 {
    ...
    return ubwww.Route{Path: "GET /admin/roles/{id}/permissions", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RolePermissionsAddRoute(adapter ubdata.DataAdapter, mgmt ubmanage.ManagementService) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        idStr := r.PathValue("id")
        id, err := strconv.ParseInt(idStr, 10, 64)
        if err != nil || id <= 0 {
    ...
    return ubwww.Route{Path: "POST /admin/roles/{id}/permissions/add", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RolePermissionsRemoveRoute(adapter ubdata.DataAdapter, mgmt ubmanage.ManagementService) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        idStr := r.PathValue("id")
        id, err := strconv.ParseInt(idStr, 10, 64)
        if err != nil || id <= 0 {
    ...
    return ubwww.Route{Path: "POST /admin/roles/{id}/permissions/remove", RequiresPermission: PermSystemAdmin, Func: handler}
}
...
func RoleCreateRoute(mgmt ubmanage.ManagementService) ubwww.Route {
    ...
    return ubwww.Route{Path: "GET /admin/roles/new", RequiresPermission: PermSystemAdmin, Func: handler}
}
...
func RoleEditRoute(mgmt ubmanage.ManagementService) ubwww.Route {
    ...
    return ubwww.Route{Path: "GET /admin/roles/{id}/edit", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RoleCreatePostRoute(mgmt ubmanage.ManagementService) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
    ...
    return ubwww.Route{Path: "POST /admin/roles/new", RequiresPermission: PermSystemAdmin, Func: handler}
}

func RoleEditPostRoute(mgmt ubmanage.ManagementService) ubwww.Route {
    handler := func(w http.ResponseWriter, r *http.Request) {
        if r.Method != http.MethodPost {
            http.Error(w, "Method Not Allowed", http.StatusMethodNotAllowed)
            return
    ...
    return ubwww.Route{Path: "POST /admin/roles/{id}/edit", RequiresPermission: PermSystemAdmin, Func: handler}
}
